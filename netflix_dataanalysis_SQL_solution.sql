...
-- Release all the movies releaed in 2020
select * from netflix
...
-- Lit all the movies that are documentaries
select *
from netflix
...
select * 
from netflix
where cast_ ilike '%Salman Khan%' and release_year>extract(year from current_date)-10;
